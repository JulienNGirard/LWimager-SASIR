//# CoSeImageSkyModel.h: Definition for CoSeImageSkyModel
...
//#
//#
//# $Id: CoSeImageSkyModel.h,v 1.1 2013/12/04 16:51:29 garsden Exp garsden $

#ifndef SYNTHESIS_COSEIMAGESKYMODEL_H
#define SYNTHESIS_COSEIMAGESKYMODEL_H
...
class CoSeImageSkyModel : public CleanImageSkyModel {
public:
  ...
  Bool do_cs_convolve;
  Bool AllOutput;
  void setMinimization(const String& s) { minimization = s; }
  void setTransform(const String& s) { transform = s; }
  void setkSigma(const Float d) { ksigma = d; }
  void setNbScales(const Int i) {NbScales=i; }
  void setPositivity(const Bool b) {Positivity=b;}
  void setNoCoarse(const Bool b) {No_Coarse=b;}
  void setVerbose(const Bool b) {verbose=b;}
  void setTolVar(const float d) {TolVar=d;}
  void setdoConvolve(const Bool b) {do_cs_convolve=b;}
  void setAllOutput(const Bool b) {AllOutput=b;}


  String getMinimization() { return minimization; }
  String getTransform() { return transform; }
  Float  getkSigma() { return ksigma; }
  Float  getTolVar() { return TolVar; }
  Int getNbScales() {return NbScales;}
  Bool getPositivity() {return Positivity;}
  Bool getNoCoarse() {return No_Coarse;}
  Bool getVerbose() {return verbose;}
  Bool getdoConvolve() {return do_cs_convolve;}
  Bool getAllOutput() {return AllOutput;}
